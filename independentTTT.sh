...
python run_exp.py -e ttt -a PPO -rid 0 -rls 150000 -cuda "cuda:0"

python run_exp.py -e ttt -a PPO -rid 1 -rls 150000 -cuda "cuda:0" &
python run_exp.py -e ttt -a PPO -rid 2 -rls 150000 -cuda "cuda:0"

python run_exp.py -e ttt -a PPO -rid 3 -rls 150000 -cuda "cuda:0" &
python run_exp.py -e ttt -a PPO -rid 4 -rls 150000 -cuda "cuda:0"
